...
\begin{document}
  ...
  \begin{frame}
    ...
    As we see later, this problems are feasible for a quantum computer.
  \end{frame}
  ...
  \begin{frame}
    ...
    Prime factorization is one of the bases of public key cryptosystems, since it's a \textit{hard problem},
    since finding the prime factorization of an $n$-bit integer requires
    \begin{equation*}
    ...
    \end{equation*}
    operations \cite{nielsen-chuang} \cite{de-wolf}.
